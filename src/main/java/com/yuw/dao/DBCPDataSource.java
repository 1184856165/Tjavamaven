...
public class DBCPDataSource {
    ...
    public static synchronized DataSource getDataSource(){
        ...
        if(dataSource == null){
            ...
            String strURL4Mysql8 = "jdbc:mysql://localhost:3306/tjise202103?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=Hongkong&allowPublicKeyRetrieval=true";
            String strURL4Mysql5 = "jdbc:mysql://localhost:3306/tjise202103?useUnicode=true&characterEncoding=utf8";
